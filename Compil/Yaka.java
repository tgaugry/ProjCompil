 ...
 */
  ...
  static final public void valeur() throws ParseException {
    ...
    case entier:
      jj_consume_token(entier);
                 expression.addImmediate(TypeVar.INT); yvm.lireImmediat(YakaTokenManager.entierLu);
      break;
    case ident:
      jj_consume_token(ident);
    ...
    case VRAI:
      jj_consume_token(VRAI);
                 expression.addImmediate(TypeVar.BOOL); yvm.lireImmediat(YakaConstants.VRAI);
      break;
    case FAUX:
      jj_consume_token(FAUX);
                 expression.addImmediate(TypeVar.BOOL); yvm.lireImmediat(YakaConstants.FAUX);
      break;
    default:
      jj_la1[13] = jj_gen;
      jj_consume_token(-1);
