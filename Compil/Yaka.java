 ...
 */
  ...
  static final public void valeur() throws ParseException {
    ...
    case entier:
      jj_consume_token(entier);
                 expression.addImmediate(TypeVar.INT);
      break;
    case ident:
      jj_consume_token(ident);
    ...
    case VRAI:
      jj_consume_token(VRAI);
                 expression.addImmediate(TypeVar.BOOL);
      break;
    case FAUX:
      jj_consume_token(FAUX);
                 expression.addImmediate(TypeVar.BOOL);
  ...
  static final public void opAdd() throws ParseException {
    ...
    case 50:
      jj_consume_token(50);
                 expression.addOp(TypeOp.ARITH2);
      break;
    case 51:
      jj_consume_token(51);
                 expression.addOp(TypeOp.ARITH2);
    ...
    case OU:
      jj_consume_token(OU);
                 expression.addOp(TypeOp.LOGIQUE2);
      break;
    default:
      jj_la1[15] = jj_gen;
      jj_consume_token(-1);
  ...
  static final public void opNeg() throws ParseException {
    ...
    case 51:
      jj_consume_token(51);
                 expression.addOp(TypeOp.ARITH1);
      break;
    case NON:
      jj_consume_token(NON);
                 expression.addOp(TypeOp.LOGIQUE1);
      break;
    default:
      jj_la1[17] = jj_gen;
      jj_consume_token(-1);
