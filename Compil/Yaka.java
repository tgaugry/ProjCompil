...
/**************************************/
  ...
  static final public void type() throws ParseException {
    ...
    case ENTIER:
      jj_consume_token(ENTIER);
              type = YakaConstants.ENTIER;
      break;
    case BOOLEEN:
      jj_consume_token(BOOLEEN);
              type = YakaConstants.BOOLEEN;
      break;
    default:
      jj_la1[5] = jj_gen;
      jj_consume_token(-1);
 ...
 */
  ...
  static final public void affectation() throws ParseException {
    jj_consume_token(ident);
             expression.stockeIdent(YakaTokenManager.identLu);
    jj_consume_token(42);
    expression();
 ...
 */
  ...
  static final public void valeur() throws ParseException, TabIdent.NoSuchKeyException, TabIdent.KeyAlreadyThereException {
    ...
    case VRAI:
      jj_consume_token(VRAI);
                 expression.addImmediate(YakaConstants.BOOLEEN); yvm.lireImmediat(YakaConstants.VRAI);
      break;
    case FAUX:
      jj_consume_token(FAUX);
